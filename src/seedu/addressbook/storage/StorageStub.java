...
/**
 * Represents the stub used to store address book data.
 */
public class StorageStub extends Storage {
     ...
     */
    public StorageStub() throws IllegalValueException {
     ...
     * @throws IllegalValueException 
     */
    public StorageStub(String filePath) throws IllegalValueException {
    	super(filePath);
        try {
